...
This application requires:
    1) Ruby <tt>ruby '2.4.0'<\tt>
    2) <tt>rails 4.2.5.1<\tt> or later. (Tested on 5)
    3) All gemed loaded with <tt>bundle install<\tt> command
